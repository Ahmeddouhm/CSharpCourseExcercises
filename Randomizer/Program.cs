...
string buffer = "ABCDEFGHIJKLMNOPQRSTUVWXYZ/abcdefghijklmnopqrstuvwxyz/123456789/!@#$%^&*[]";
string[] newbuffer = buffer.Split('/' , 4);
...
static void GenerateComplexString(int stLn) 
{
    Random rnd = new Random();
    var sb = new StringBuilder();
    while (sb.Length < stLn)
